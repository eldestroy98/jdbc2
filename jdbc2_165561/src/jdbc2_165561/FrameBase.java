...
public class FrameBase extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Datos de juegos de ivan:");
    ...
    public static void main(String args[]) {
        ...
        try{
            ...
            con=DriverManager.getConnection("jdbc:mysql://localhost:3306/tarea1BD?serverTimezone=UTC",user,password);
            ...
            while(resultSet.next()){
                ...
                acumular = (DefaultTableModel) tablaVideojuegos.getModel();
                Object[] obj = {nombre,desarrolladora,rating};
                acumular.addRow(obj);
            }
